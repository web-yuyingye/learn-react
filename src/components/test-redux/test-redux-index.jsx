...
function TestReduxIndex({ children }) {
  const menuList = [
    { name: '商品列表', path: '/react-redux/goodsList' },
    { name: '购物车', path: '/react-redux/buyGoodsList' },
    { name: 'count', path: '/react-redux/count' },
  ];
